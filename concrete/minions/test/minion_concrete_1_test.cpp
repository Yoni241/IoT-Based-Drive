...
int main()
{
    ...
    try 
	{
        ...
        minionIp = minionUDPConfig["data"][0]["ip"];
        minionPort = minionUDPConfig["data"][0]["port"];
        memFilePath = minionUDPConfig["data"][0]["memory_file"];
        memorySize = minionUDPConfig["data"][0]["size"];
