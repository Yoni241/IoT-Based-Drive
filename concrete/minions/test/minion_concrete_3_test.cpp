...
int main()
{
    ...
    try 
	{
        ...
        minionIp = minionUDPConfig["data"][2]["ip"];
        minionPort = minionUDPConfig["data"][2]["port"];
        memFilePath = minionUDPConfig["data"][2]["memory_file"];
        memorySize = minionUDPConfig["data"][2]["size"];
